    ...
    <>
      <CRow>
        <CCol xs="12">
          ...
          {updateStatus == false && (
            <CCard style={{ borderRadius: "3rem", backgroundColor: "gold", }}>
              <CCardHeader style={{ backgroundColor: "black" }}>
                <h4 style={{ color: "white", }} className='m-0'>Employee Registeration</h4>
              </CCardHeader>
              <CCardBody>
                ...
                <CRow style={{ justifyContent: "center", marginTop: "30px" }}>
                  ...
                  <CButton className="form-btn" onClick={saveClick} style={{ backgroundColor: "#3DD07D", color: "white", }}>
                    Save
                  </CButton>
          ...
          {updateStatus == true && (
            <CCard style={{ borderRadius: "3rem", backgroundColor: "gold", }}>
              <CCardHeader style={{ backgroundColor: "black" }}>
                <h4 style={{ color: "white", }} className='m-0'>Edit Your Information</h4>
              </CCardHeader>
              <CCardBody>
